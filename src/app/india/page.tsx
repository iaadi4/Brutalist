  ...
  return (
    <PageTransition>
      <div className="flex flex-col min-h-screen bg-[var(--color-brutal-bg)]">
          ...
          {indiaData.masterworks.map((work, index) => (
            ...
            >
              ...
              <div className={`col-span-1 lg:col-span-5 p-8 lg:p-16 flex flex-col justify-center ${index % 2 === 0 ? 'order-2 lg:order-1' : 'order-2 lg:order-2'}`}>
                <GsapScrollReveal>
                  <div className="mb-8">
                    <span className="bg-[var(--color-brutal-black)] text-[var(--color-brutal-white)] px-4 py-2 font-mono font-bold text-2xl brutal-border-sm mb-6 inline-block">
                      {work.architect}
                    </span>
                  ...
                  <div className="flex flex-col gap-2 mb-12">
                     <span className="font-mono text-2xl font-bold bg-[var(--color-brutal-red)] text-white px-3 py-1 w-fit brutal-border">{work.location}</span>
                  </div>
                  
                  <p className="text-2xl lg:text-3xl font-medium leading-relaxed text-justify">
                    {work.description}
                  </p>
                </GsapScrollReveal>
              </div>
        ...
        {/* Regional Transition */}
        <section className="bg-[var(--color-brutal-yellow)] p-8 lg:p-24 border-t-[16px] border-[var(--color-brutal-black)]">
            <GsapScrollReveal>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
                ...
                <div className="flex flex-col gap-16">
                    ...
                    {indiaData.regional_transition_bihar.modern_intervention.map((item, i) => (
                        <div key={i} className="bg-[var(--color-brutal-bg)] brutal-border p-8 lg:p-12 flex flex-col gap-8 relative overflow-hidden group">
